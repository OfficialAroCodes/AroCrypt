...
const ToastNotification = ({ type, message, title, onDone }: ToastInterface) => {
    ...
    return (
        <div className={`toast_notification ${visible ? 'show' : ''} ${type === 1 ? 'success' : type === 2 ? 'warn' : 'error'}`}>
            <span className="icon">
                {
                    type === 1 ? (
